...
pub fn instantiate_from_value(value: BasicValueEnum, context: &FnContext) -> Value {
    ...
    let instance_ptr = native::gen_malloc(&context.core.llvm_boolean_class.llvm_struct_type_ref.get().unwrap(), context);
    ...
    Value::Class(instance_ptr, context.core.llvm_boolean_class)
}
