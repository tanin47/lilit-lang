  ...
  "hello"
           ...
           Ok((
               ...
               Method {
                   ...
                   return_type: Type::init(Some(span(1, 13, "Number"))),
                   parent_class: None,
                   llvm: Cell::new(None)
               }
           ))
                ...
                Method {
                    ...
                    params: vec![
                        Param {
                            ...
                            tpe: Type::init(Some(span(1, 13, "String"))),
                            is_varargs: false,
                            index: 0,
                            parent: None,
                            llvm: Cell::new(None),
                        ...
                        Param {
                            ...
                            tpe: Type::init(Some(span(1, 27, "String"))),
                            is_varargs: true,
                            index: 1,
                            parent: None,
                            llvm: Cell::new(None),
                    ...
                    exprs: vec![],
                    return_type: Type::init(Some(span(1, 36, "Number"))),
                    parent_class: None,
                    llvm: Cell::new(None)
                }
            ))
