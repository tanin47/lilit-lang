...
%struct.Process = type { i32, i32, i32, i32 }
...
; <label>:51:                                     ; preds = %23, %1
  ...
  %64 = call noalias i8* @GC_malloc(i64 16) #4
  %65 = bitcast i8* %64 to %struct.Process*
  store %struct.Process* %65, %struct.Process** %7, align 8
  %66 = load i32, i32* %6, align 4
  %67 = load %struct.Process*, %struct.Process** %7, align 8
  %68 = getelementptr inbounds %struct.Process, %struct.Process* %67, i32 0, i32 0
  store i32 %66, i32* %68, align 4
  %69 = load i32*, i32** %3, align 8
  %70 = getelementptr inbounds i32, i32* %69, i64 1
  %71 = load i32, i32* %70, align 4
  %72 = load %struct.Process*, %struct.Process** %7, align 8
  %73 = getelementptr inbounds %struct.Process, %struct.Process* %72, i32 0, i32 1
  store i32 %71, i32* %73, align 4
  %74 = load %struct.Process*, %struct.Process** %7, align 8
  %75 = getelementptr inbounds %struct.Process, %struct.Process* %74, i32 0, i32 2
  store i32 10, i32* %75, align 4
  %76 = load i32*, i32** %5, align 8
  %77 = getelementptr inbounds i32, i32* %76, i64 0
  %78 = load i32, i32* %77, align 4
  %79 = load %struct.Process*, %struct.Process** %7, align 8
  %80 = getelementptr inbounds %struct.Process, %struct.Process* %79, i32 0, i32 3
  store i32 %78, i32* %80, align 4
  %81 = load %struct.Process*, %struct.Process** %7, align 8
  ret %struct.Process* %81
}
...
; Function Attrs: noinline nounwind optnone uwtable
define %struct.Process* @test_call() #0 {
  %1 = alloca %struct.Process*, align 8
  %2 = call noalias i8* @GC_malloc(i64 16) #4
  %3 = bitcast i8* %2 to %struct.Process*
  store %struct.Process* %3, %struct.Process** %1, align 8
  %4 = load %struct.Process*, %struct.Process** %1, align 8
  %5 = getelementptr inbounds %struct.Process, %struct.Process* %4, i32 0, i32 0
  store i32 2, i32* %5, align 4
  %6 = load %struct.Process*, %struct.Process** %1, align 8
  %7 = getelementptr inbounds %struct.Process, %struct.Process* %6, i32 0, i32 1
  store i32 3, i32* %7, align 4
  %8 = load %struct.Process*, %struct.Process** %1, align 8
  %9 = getelementptr inbounds %struct.Process, %struct.Process* %8, i32 0, i32 2
  store i32 10, i32* %9, align 4
  %10 = load %struct.Process*, %struct.Process** %1, align 8
  %11 = getelementptr inbounds %struct.Process, %struct.Process* %10, i32 0, i32 3
  store i32 9, i32* %11, align 4
  %12 = load %struct.Process*, %struct.Process** %1, align 8
  ret %struct.Process* %12
}
